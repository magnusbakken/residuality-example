...
| Category | Prompt |
|---|---|
| Regulatory & Legal | "What regulation about facial recognition or biometric data could be created in the next 3 years that would hit NovaMesh hardest?" |
| Competitive & Market | "What could Ring, Google, or a new entrant do that NovaMesh currently has no answer to?" |
| Technical & Infrastructure | "What technical dependency in the recognition pipeline is everyone in this room assuming will always work?" |
| Organisational & People | "What people or knowledge situation would most cripple NovaMesh's ability to maintain safe and accurate facial recognition?" |
| Environmental & Physical | "What physical-world event would make the fact that this product controls a door lock most dangerous?" |
| Reputational & Social | "What could go wrong with facial recognition that would be hardest to explain to a journalist — or a court?" |
...
| Dice Total | Trigger |
|---|---|
| 2 | "All home broadband speeds drop to 1Mbps globally due to a submarine cable incident — face frames cannot be sent to the cloud for recognition" |
...
| 7 | "A widely-shared academic paper proves that NovaMesh's facial recognition AI has a significantly higher false-accept rate for certain demographics" |
